...
<linearGradient id="Ld6sqrtcxMyckEl6xeDdMa_uLWV5A9vXIPu_gr1" x1="9.993" x2="40.615" y1="9.993" y2="40.615" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#2aa4f4"></stop><stop offset="1" stopColor="#007ad9"></stop></linearGradient><path fill="url(#Ld6sqrtcxMyckEl6xeDdMa_uLWV5A9vXIPu_gr1)" d="M24,4C12.954,4,4,12.954,4,24s8.954,20,20,20s20-8.954,20-20S35.046,4,24,4z"></path><path fill="#fff" d="M26.707,29.301h5.176l0.813-5.258h-5.989v-2.874c0-2.184,0.714-4.121,2.757-4.121h3.283V12.46 c-0.577-0.078-1.797-0.248-4.102-0.248c-4.814,0-7.636,2.542-7.636,8.334v3.498H16.06v5.258h4.948v14.452 C21.988,43.9,22.981,44,24,44c0.921,0,1.82-0.084,2.707-0.204V29.301z"></path>
                ...
                <p className='mt-5 text-center text-sm'>Or connect with</p>
            ...
            <div className="relative flex items-center mt-5">
                ...
                <input type="email" className="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-[#8064A2] dark:focus:border-[#8064A2] focus:ring-[#8064A2] focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address" />
            </div>
            ...
            <div className="relative flex items-center mt-4">
                ...
                <input type="password" className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-[#8064A2] dark:focus:border-[#8064A2] focus:ring-[#8064A2] focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password" />
            ...
            <div className="mt-6">
                <button className="w-full px-6 py-3 text-sm font-medium bg-[#8064A2] text-white rounded-xl">
                    Agree and Continue
                </button>
